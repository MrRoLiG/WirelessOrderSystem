...
public class AddDishActivity extends Activity{
		...
		confirmBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
        	    ...
        	    if((dishName.equals(""))||(dishType.equals(""))||(dishPrice.equals(""))||(picPath.equals(""))) {
	        		   Toast.makeText(AddDishActivity.this, "请完善需要添加的菜品信息!", Toast.LENGTH_LONG).show();
	        	   }
        	    else {
	...
	private String upLoadPicture(final String str)
	{
		...
		{
			Toast.makeText(AddDishActivity.this, "图片上传失败", 1);
			return "";
		}
		else {
			Toast.makeText(AddDishActivity.this, "图片上传成功", 1);
			return tipsStr;
		}
